...
import { ShoppingBag, Mail, Lock, Eye, EyeOff, ArrowRight, User, Store, ShoppingCart } from "lucide-react";
...
const Signup = () => {
  ...
  const { siteName, logoUrl, heroBackgroundUrl, heroOverlayOpacity } = useSiteSettingsContext();
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <Link to="/" className="flex items-center gap-2 mb-8">
            ...
            <span className="text-xl font-bold text-gradient-primary">{siteName}</span>
          </Link>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button
              ...
              className={`p-4 rounded-2xl border-2 transition-all duration-300 text-left ${selectedRole === "buyer"
            ...
            <button
              ...
              className={`p-4 rounded-2xl border-2 transition-all duration-300 text-left ${selectedRole === "vendor"
                ? "border-primary bg-accent"
                : "border-border hover:border-primary/50"
                }`}
            >
      ...
      <div
        className="hidden lg:flex flex-1 items-center justify-center p-12 relative overflow-hidden bg-cover bg-center transition-all duration-500"
        style={{
          backgroundImage: heroBackgroundUrl ? `url(${heroBackgroundUrl})` : undefined,
        }}
      >
        <div className={`absolute inset-0 ${!heroBackgroundUrl && 'bg-gradient-hero'}`} />
        <div
          className="absolute inset-0 bg-black"
          style={{ opacity: heroBackgroundUrl ? heroOverlayOpacity : 0.1 }}
        />
        ...
        <div className="relative z-10 text-center text-white max-w-lg">
          ...
          <p className="text-xl text-white/80">
            {selectedRole === "vendor"
              ? `Join hundreds of student entrepreneurs already earning on ${siteName}.`
