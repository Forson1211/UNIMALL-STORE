    ...
    <section className="py-16 md:py-32 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12 md:mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 md:px-4 md:py-1.5 rounded-none bg-primary text-white text-[9px] md:text-[10px] font-black uppercase tracking-widest mb-6 md:mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 border border-border/40">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-8 md:p-12 bg-white rounded-none border border-border/20 hover:bg-muted/30 transition-all duration-300 relative overflow-hidden"
            >
              ...
              <div className={`w-12 h-12 md:w-14 md:h-14 rounded-none ${feature.color} flex items-center justify-center mb-6 md:mb-8 shadow-xl shadow-black/10 group-hover:scale-110 transition-transform duration-500`}>
                <feature.icon className="w-6 h-6 md:w-7 md:h-7 text-white" />
              </div>
              
              <div className="space-y-3 md:space-y-4">
                <h3 className="text-xl md:text-2xl font-black text-foreground tracking-tight uppercase">{feature.title}</h3>
